"""
Loads Push-T oracle episodes: videos, states, velocities, actions, start observation, and goal observation. 
Used by build.py to construct expert feasibility data.
"""
...
def load_oracle_episode(base_dir: str | Path, episode_idx: int) -> dict[str, Any]:
    ...
    abs_actions = torch.load(base / "rel_actions.pth")
