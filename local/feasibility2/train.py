...
try:
    ...
    from local.feasibility2.dataset import FeasibilityDataset, load_tensor_dataset
    from local.feasibility2.model import FeasibilityModel, TransformerFeasibilityModel
    from local.feasibility2.scheduler import SigmaScheduler, LogUniformSigmaScheduler
...
def main() -> None:
    ...
    if args.delta_target_mode == "wm_residual":
        from local.feasibility2.build import load_world_model
