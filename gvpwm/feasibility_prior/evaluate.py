...
try:
    ...
    from gvpwm.feasibility_prior.dataset import load_tensor_dataset
    from gvpwm.feasibility_prior.model import FeasibilityModel, load_feasibility_model_from_checkpoint
